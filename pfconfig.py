...
SLIDERS = {
    ...
    'video_ratio_videos': (0, 100),
    'video_ratio_total': (1, 100),
...
FRIENDLY_NAMES = {
    ...
    "peripherals.buttons.display_off.label": "Display Off Label",
    ...
    "viewer.video_ratio_enabled": "Enable Video Ratio",
    "viewer.video_ratio_videos": "Video Ratio Numerator (X)",
    "viewer.video_ratio_total": "Video Ratio Denominator (Y)",
    "viewer.video_quarantine_days": "Video Cooldown Days",
...
MENU_STRUCTURE = {
    ...
    "Videos": [
        "viewer.video_ratio_enabled",
        "viewer.video_ratio_videos",
        "viewer.video_ratio_total",
        "viewer.video_every_n_photos",
        "viewer.video_quarantine_days",
        "viewer.video_fit_display",
        "viewer.video_volume",
