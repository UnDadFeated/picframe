...
if [ "$LAST_COMPLETED_STEP" -lt 5 ]; then
    ...
    su - pi -c "git clone https://github.com/UnDadFeated/picframe.git /home/pi/picframe_src" 2>&1 | tee -a "$LOG_FILE"
    su - pi -c "/home/pi/venv_picframe/bin/pip install /home/pi/picframe_src" 2>&1 | tee -a "$LOG_FILE"
